...
export default function AmeyPage() {
      ...
      <div className="h-full w-full bg-black flex-col relative pt-10">
        ...
        <div className="w-full h-3/6 flex flex-col items-center mt-4 pt-12">
          ...
          <div className="text-center text-white mt-8">
            <h2 className="text-4xl font-bold">Amey Bhandari</h2>
            <h3 className="text-xl mt-2">Developer</h3>
            <p className="mt-4 text-gray-400 max-w-md">
              Computer science student at Purdue University, from Delhi, India.
              1st year in Hack the Future, excited to work on something cool!.
            </p>
          </div>
